        ...
        {steps.map((step, id) => (
          ...
          >
            <div className="flex flex-col items-center md:flex-row">
              ...
              >
                <step.icon
                  className={`size-7 p-1 transition-all md:size-8 ${activeIndex !== id ? "text-gray-disabled" : "scale-125 text-white"}`}
                />
              </div>
            ...
            <div className="ml-6 inline-flex flex-col gap-y-4 pe-8 md:ml-0 md:mt-[34px]">
              <h3
                className={`text-body-1 font-bold transition-all md:mt-4 md:text-2xl  ${activeIndex !== id ? "text-gray-disabled" : "text-dark"}`}
              >
                {step.title}
              </h3>
              <p
                className={`mb-[68px] text-body-2base md:mb-0 md:mt-2 md:text-body-2 ${activeIndex !== id ? "text-gray" : "text-gray-600 "}`}
              >
                {step.paragraph}
              </p>
            </div>
